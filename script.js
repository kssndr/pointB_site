...
var reviewData = [
  ...
  {
    photo: "img/cases/Bstar.png",
    text: "Твои сессии придали мне силы и уверенность пойти на курсы ораторского искусства — то, что раньше было для меня немыслимо. Уже есть успехи как на самих курсах, так и в работе. Это открыло передо мной новые возможности, за которые я ухватился. Дало смелость не просто покоряться, а аргументированно противостоять и отвечать за результат.<br>Я начал заниматься тем, чем всегда хотел — искусственным интеллектом в рамках текущей компании, на постоянном проекте, в новой должности.<br>Спасибо, что помогла мне оттолкнуться от земли и запуститься.",
    author: "Сергей Телицын"
  },
  {
    photo: "img/cases/Bstar.png",
    text: "Инна, хочу выразить огромную благодарность!<br>После ваших встреч с моим сотрудником, она прямо перезапустилась и сильно изменилась. Она стала лучшим сотрудником, и я теперь бесконечно доверяю ей. Сейчас я передаю ей часть своих задач, доверяя ей роль операционного директора. К тому же мы повысили ей оклад, как она и мечтала.<br>После сессий с тобой всегда чувствую легкость. Когда какой-то вопрос долго не дает покоя, на встрече ты помогаешь найти решение или хотя бы проясняешь, что нужно делать дальше. Эти сессии расширяют мои горизонты, я начинаю видеть ситуацию с разных сторон и заглядывать дальше. Ты мягко поддерживаешь, позволяя мне взять на себя ответственность за мои действия, и я чувствую, что не одна в своих переживаниях и решениях.<br>Я также очень довольна тем, что прошла у тебя первую ступень курса по коучингу. Это стало настоящим открытием для меня, и я однозначно порекомендовала бы пройти этот курс каждому хотя бы для профилактики. Эти навыки помогают не только в работе, но и в повседневной жизни, снижая количество конфликтных ситуаций. Ты учишь, как правильно отслеживать эмоции, грамотно задавать вопросы и поддерживать диалог. Формат обучения удобный, всегда есть поддержка и возможность получить ответы на вопросы. Все проходит очень комфортно!",
    author: "Полина Тумашик"
  },
  {
    photo: "img/cases/Bstar.png",
    text: "Меня зовут Елена Набокова, я директор и владелец театра-студии 'Дом Культуры'.<br>Хочу выразить огромную благодарность Инне за проделанную работу. Я обратилась с запросом на пересборку бизнеса и вывод его на новый уровень. <br>Во время работы мы смогли конкретизировать задачу — продажу услуг театральной деятельности.<br>Благодаря нашей совместной работе, мне удалось выделить ключевые направления и начать перенастраивать работу студии, так как многие бизнес-процессы стали более понятными. Мы распутали довольно запутанный клубок, и сейчас, когда процессы и задачи стали четкими, у театра началась вторая жизнь. Группы стали собираться легче, и поступают предложения от корпоративного сектора.<br>Сейчас мы движемся не вслепую, а осознанно и уверенно.<br>У Инны есть настоящий талант — объяснять сложные вещи простым языком и задавать правильные вопросы. Помощь пришла в самый нужный момент. Огромное спасибо!<br>",
    author: "Елена Набокова"
  }
];
